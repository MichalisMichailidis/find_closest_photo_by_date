        ...
        foreach(glob('.***image path*** *.*') as $filename){
            $filename = str_replace(".***image path***", "", $filename);
        ...
        if($number_of_photos_with_older_datename_in_array == 0){
               echo "<img class='next-game-photo' src='***image path***' />";
        }else{

         echo "<img class='next-game-photo' src='***image path***" .  $photos_array_with_older_datename[0] . ".jpg' />";
         };
